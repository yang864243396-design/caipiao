...
func TestResolveSolo_realBetMatrix20260728(t *testing.T) {
	cases := []soloCase{
		...
		// 前中后三 / 前后三 组合：多区位须 solo=true（与混合组选注数阈不同）
		{"前中后三组合", "g007", "105", "前中后三组合", "前中后三", "前中后三直选", "1,2,3", 9, true},
		// 前中后三混合组选：按总注数 ≤3 solo（123→3）；≥4 不可（见 TestResolveSolo_qianZhongHou3HunheByBets）
		{"前中后三混合组选3注", "g007", "110", "前中后三混合组选", "前中后三", "前中后三组选", "123", 3, true},
		{"前后三组合", "g012", "93", "前后三组合", "前后三", "前后三直选", "1,2,3", 6, true},
		{"前后三混合组选2注", "g012", "98", "前后三混合组选", "前后三", "前后三组选", "123", 2, true},

		// 任选直选单式：单注须单挑，与同组直选复式一致（原实现多了 k>=4 条件）
		{"任二直选单式", "g011", "75", "任二直选单式", "任选", "任选二", "千个|12", 1, true},
		{"任三直选单式", "g011", "81", "任三直选单式", "任选", "任选三", "万千个|123", 1, true},

		// 中三混合组选：≤3 注须 solo；≥4 注不可 solo（2026-07-30 rule=23 实测矩阵）
		{"中三混合组选单注", "g002", "23", "中三混合组选", "中三码", "中三组选", "210", 1, true},
		{"中三混合组选2注", "g002", "23", "中三混合组选", "中三码", "中三组选", "123,456", 2, true},
		{"中三混合组选3注", "g002", "23", "中三混合组选", "中三码", "中三组选", "123,456,987", 3, true},
		{"中三混合组选4注", "g002", "23", "中三混合组选", "中三码", "中三组选", "123,456,789,147", 4, false},
		{"中三混合组选8注", "g002", "23", "中三混合组选", "中三码", "中三组选", "210,219,280,289,410,419,480,489", 8, false},

		// 中三组六：号池 5 码 → C(5,3)=10，须 solo=false（def-1-1785393059421）
		{"中三组六单注", "g002", "261", "中三组六", "中三码", "中三组选", "1,2,3", 1, true},
		{"中三组六4注", "g002", "261", "中三组六", "中三码", "中三组选", "1,2,3,4", 4, false},
		{"中三组六10注", "g002", "261", "中三组六", "中三码", "中三组选", "1,2,6,9,8", 10, false},
		// 中三组三：≤6 可 solo，≥12 不可
		{"中三组三6注", "g002", "19", "中三组三", "中三码", "中三组选", "1,2,3", 6, true},
		{"中三组三12注", "g002", "19", "中三组三", "中三码", "中三组选", "1,2,3,4", 12, false},
	}
